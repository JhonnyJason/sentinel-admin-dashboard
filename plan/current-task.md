...
- `show full ranking` display the current full list of ForexPairs with their scores in order. -> Should be 100% the same of what the user would see in their Dashboard (Button)
...
- Normalization parametes of each Economic area.
- DiffFunction weights
...
## Sub Task
- [ ] create implementation plan and define further sub tasks