...
## Sub-Tasks
- [x] add relevant structure in the forexscoreframemodule/forexscoreframe.pug
- [x] add relevant style in the forexscoreframemodule/styles.styl
- [x] adjust the code in comboboxfun.coffee and use it from forexscoreframemodule/forexscoreframemodule.coffee
- [x] test the implementation and fix the issues